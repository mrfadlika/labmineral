<?php
// ============================================================
//  xrf_php/index.php — Data Lengkap Pengukuran XRF Explorer 7000 (Versi PHP)
// ============================================================
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;flex-wrap:wrap;gap:10px">
    <div>
        <div class="sec-title" style="margin-bottom:2px">⚡ Data Pengukuran XRF Explorer 7000 <span style="font-size:0.75rem;padding:2px 8px;background:rgba(56,189,248,0.15);color:#38bdf8;border:1px solid rgba(56,189,248,0.3);border-radius:12px;font-weight:600;margin-left:6px">Versi PHP</span></div>
        <p style="font-size:.78rem;color:var(--text3);margin:0">Database lengkap riwayat hasil scan spektrometri genggam XRF yang tersimpan di MySQL server.</p>
    </div>
    <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
        <a href="<?= BASE_URL ?>/xrf_php/dashboard.php" class="btn btn-sm" style="background:#1e293b;border:1px solid #38bdf8;color:#38bdf8;padding:6px 12px;font-weight:600">
            📡 Monitor Realtime
        </a>
        <a href="<?= BASE_URL ?>/xrf/index.html" class="btn btn-sm" style="background:linear-gradient(135deg,#0284c7,#0369a1);color:#fff;border:1px solid #38bdf8;padding:6px 12px;font-weight:600" title="Buka Aplikasi XRF Standalone JS">
            🚀 Buka Standalone JS App &rarr;
        </a>
    </div>
</div>
...
<!-- Filter Bar -->
<form method="GET" action="<?= BASE_URL ?>/xrf_php/index.php" style="display:flex;gap:8px;margin-bottom:14px;flex-wrap:wrap;align-items:center;background:var(--bg3);border:1px solid var(--border);border-radius:8px;padding:10px 12px">
    ...
    <input name="fsearch" value="<?= bersihkan($fSearch) ?>" placeholder="🔍 Cari sampel, operator, grade, curve, device..."
    ...
    <a href="<?= BASE_URL ?>/xrf_php/index.php" class="btn btn-sm" style="background:var(--bg2);color:var(--text2);border:1px solid var(--border);padding:6px 10px">Reset</a>
</form>
